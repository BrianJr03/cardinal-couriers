...
//                new Inventory(collectItemsAsArrayList( storePicker() ));
...
//                case "6" -> storeInventory = new Inventory(collectItemsAsArrayList( storePicker() ));
//            }
//            selection = selectMenuOption();
//        }
//    }

//    public static String storePicker() throws IOException {
